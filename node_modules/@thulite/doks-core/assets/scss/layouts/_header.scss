...
.dropdown-menu {
    ...
    border: 1px solid $gray-200; // Add a border
...
.dropdown-item {
    padding: 0.5rem 1rem; // Adjust padding for items
    color: $body-color; // Set text color

    &:hover {
        background-color: $gray-100; // Change background on hover
        color: $primary; // Change text color on hover
    }

    &:active {
        background-color: $gray-200; // Active state
    }
}

.dropdown-divider {
    border-top: 1px dashed $gray-200; // Style for dividers in dropdown
}
